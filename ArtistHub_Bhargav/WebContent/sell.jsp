        ...
        <div class="row px-sm-5">
            <div class="col-lg-7 mb-10">
                <div class="contact-form">
                    <div id="success"></div>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <form action="BookServlet" name="add book" method="post" id="contactForm" enctype='multipart/form-data'>
                    <input type="hidden" name="seller" value="<%=u.getUid() %>">
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" placeholder="enter name of book" name="name"
                                required="required" data-validation-required-message="Please enter a subject" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input class="form-control" id="name" placeholder="Add Price" name="bprice"
                                required="required"
                        ...
                        Enter photo of Book:-
                              <input  type="file" id="name" name="book_pdf" class="form-control"/>
                              <p class="help-block text-danger"></p>
                        </div>
                        <div>
                            <button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton" name="action" value="add book" >Add</button>
                        </div>
                    </form>
                </div>
            </div>
