		...
		<div class="row px-xl-5">
			...
			<div class="col-lg-7 h-auto mb-30">
				<div class="h-100 bg-light p-30">
					...
					<br>
					<h3>
						Product Name : <b> <%=p.getProduct_name() %></b>
					</h3>
					<h4>
						Product Category : <b><%=p.getProduct_category() %></b>
					</h4>
					<h3 class="font-weight-semi-bold mb-4">
						Price : <b><%=p.getProduct_price() %></b>
					</h3>
					<p class="mb-4">
						Product Detail :
						<%=p.getProduct_desc() %></p>
					<div class="d-flex align-items-center mb-4 pt-2">
						...
						<a href="seller-edit-product.jsp?pid=<%=p.getPid()%>"><button
								class="btn btn-info px-3">Edit</button></a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
							href="seller-delete-product.jsp?pid=<%=p.getPid()%>"><button
								class="btn btn-danger px-3">Delete</button></a>
					</div>
				</div>
			</div>
		</div>
