...
<head>
<meta charset="UTF-8">
<title>new password-radhe</title>
</head>
<body>
<div class="hero_area">
              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form method="post" action="UserController">
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit" name ="action" value ="updatepassword" >change password</button>
                  </div>
